...
<link rel="stylesheet" href="/inc/css/customizing2.css?<?=date('YmdHis')?>">
<!-- <script type="text/javascript" src="/inc/js/jquery-3.3.1.min.js?<?=date('YmdHis')?>"></script> -->

<!-- footer에 넣은거가 안좋아서 head로 옮김 21.5.12 -->
<script src="/inc/js/jquery-3.3.1.min.js" defer></script>
<script src="/inc/js/jquery-ui.min.js" defer></script>
<script src="/inc/js/popper.min.js" defer></script>
<script src="/inc/js/bootstrap-4.1.3.min.js" defer></script>
<script src="/inc/js/datepicker-ko.js" defer></script>
<script src="/inc/js/date.format.min.js" defer></script>
<script src="/inc/js/jquery.number.min.js" defer></script>
<script src="/inc/js/etc/form.js" defer></script>
</head>
